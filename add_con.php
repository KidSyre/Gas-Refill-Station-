					...
					<div class="form-group row">
					 ...
					 <div class="form-group row">
						<label for="mno" class="col-sm-2 col-form-label">Mobile no.</label>
							<div class="col-sm-10">
								<input type="text" name="mno" class="form-control" id="mno"  name="mno" placeholder="Mobile number" pattern="[0-9]{1}[0-9]{9}" title="At least Ten Digits" maxlength=10 required />  
